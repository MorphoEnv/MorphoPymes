...
!npx hardhat init --yes 2. Instalar Dependencias de Desarrollo
...
!npm install --save-dev dotenv cross-env rimraf 3. Instalar Dependencias de Producción
...
"test:gas": "REPORT*GAS=true hardhat test",
...
"lint:js": "eslint '**/*.js'",
"format": "prettier --write '\*\*/\_.{js,json,sol,md}'",
