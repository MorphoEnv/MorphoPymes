...
!npx hardhat test test/gas/ --reporter gas 2. Tests Paralelos
...
"lint": "solhint contracts/\*_/_.sol"
}
}
...
for (let i = 0; i < 100; i++) {
const randomAmount = Math.floor(Math.random() _ 1000000);
const randomUser = accounts[Math.floor(Math.random() _ accounts.length)];
